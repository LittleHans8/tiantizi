        ...
        <nav class="sidebar-nav">
            <ul class="nav">
                <li class="nav-item">
                    ...
                    <a class="nav-link" href="{{ url('/user/readme') }}"><i class="icon-notebook"></i> 使用指南<span
                ...
                <li class="nav-item px-1 hidden-cn">
                    ...
                    <div class="progress progress-xs">
                        <div class="progress-bar bg-info" role="progressbar"
                             style="width: {{ $blankdata['user_online_count']/$blankdata['user_count']*100 }}%"
                             aria-valuenow="{{ $blankdata['user_online_count']/$blankdata['user_count']*100 }}"
                             aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <small class="text-muted"> {{ $blankdata['user_online_count'] }}/{{$blankdata['user_count']}}在线
                    </small>
                </li>
                <li class="nav-item px-1 hidden-cn">
                    <div class="text-uppercase mb-q">
